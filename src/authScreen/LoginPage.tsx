...
export const LoginPage = ({ onLogin, onSignup }: LoginPageProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://api.thismakesnosense.shop/api/auth/signin", {
        method: "POST",
        headers: {
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href = "https://api.thismakesnosense.shop/api/auth/google";
  };

  const handleForgotPassword = () => {
    if (email) {
      // Redirect to forgot password page with email
      window.location.href = `https://api.thismakesnosense.shop/auth/forgot-password?email=${encodeURIComponent(email)}`;
    } else {
      // Redirect to forgot password page
      window.location.href = "https://api.thismakesnosense.shop/auth/forgot-password";
    }
  };
