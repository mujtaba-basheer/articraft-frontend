...
export const SignupFlow = ({ onSignup, onBackToLogin }: SignupFlowProps) => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.thismakesnosense.shop/api/auth/signup", {
        method: "POST",
        headers: {
  ...
  const handleOtpVerification = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.thismakesnosense.shop/api/auth/verify-email", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      await fetch("https://api.thismakesnosense.shop/api/auth/signup", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
